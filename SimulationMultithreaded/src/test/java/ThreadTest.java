...
//Тест 1: Проверяет, что метод обновления прогресс-бара выводит правильный текст.
//Тест 2: Проверяет, что потоки выполняются и не завершаются слишком быстро, проверяя время их работы.
// Тест 3: Проверяет, что основной метод программы (main) корректно выводит информацию о трех потоках, их прогрессе и времени выполнения.